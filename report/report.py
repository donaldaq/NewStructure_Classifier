...
def make_Report(save_dir, model_name, epoch_counter_train, train_loss, epoch_counter_val, val_loss, train_acc, val_acc):
    ...
    plt.legend()
    plt.savefig("./models/{}/Loss_{}_{}.png".format(save_dir,model_name,currentTime),bbox_inces='tight',pad_inches=0,dpi=100)
    ...
    plt.legend()
    plt.savefig("./models/{}/Acc_{}_{}.png".format(save_dir,model_name,currentTime),bbox_inces='tight',pad_inches=0,dpi=100)
    #plt.show()