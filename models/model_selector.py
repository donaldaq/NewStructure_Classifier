...
def model_selector(modelName, class_names, use_fixed):
    ...
    model_settings(model_ft, model_name, use_fixed, class_names)


def model_settings(model_ft, model_name, use_fixed, class_names):
